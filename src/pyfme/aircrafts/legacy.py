...
class Cessna1720():
    ...
    def _calculate_aero_forces_moments(self, state, controls):
        q = self.q_inf
        Sw = self.Sw
        c = self.chord
        b = self.span

        self._calculate_aero_lon_forces_moments_coeffs(state, controls)
        self._calculate_aero_lat_forces_moments_coeffs(state, controls)
    ...
    def calculate_forces_and_moments(self, state, environment, controls):
        ...
        Ft = self._calculate_thrust_forces_moments(environment, controls)
        L, D, Y, l, m, n = self._calculate_aero_forces_moments(state, controls)
...
class SimplifiedCessna1720(Cessna1720):
    def __init__(self):
        super().__init__()
        self.CL_0 = 0.148
        self.CM_0 = 0.0075
    ...
    def _calculate_aero_lon_forces_moments_coeffs(self, state, controls):
        """
    ...
    def _calculate_aero_lat_forces_moments_coeffs(self, state, controls):
    ...
    def _calculate_thrust_forces_moments(self, environment, controls):
